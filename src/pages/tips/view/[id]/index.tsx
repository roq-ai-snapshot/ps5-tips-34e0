...
import { useTipFindFirst, useRoqClient } from 'lib/roq';
...
function TipViewPage() {
  ...
  const { data, error, isLoading } = useTipFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('tip', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/tips/edit/${id}`} passHref legacyBehavior>
                    <Button
