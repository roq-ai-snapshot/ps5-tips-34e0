...
import { useTrickFindFirst, useRoqClient } from 'lib/roq';

import { TrickInterface } from 'interfaces/trick';

function TrickViewPage() {
  ...
  const { data, error, isLoading } = useTrickFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('trick', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/tricks/edit/${id}`} passHref legacyBehavior>
                    <Button
