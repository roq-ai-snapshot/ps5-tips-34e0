...
export function GameListPage(props: GameListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: [, 'achievement.count', 'tip.count', 'trick.count'],
          searchTerm: params.searchTerm,
          searchTermKeys: ['name.contains', 'developer.contains', 'publisher.contains', 'genre.contains'],
          ...params.filters,
        },
        'game',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'developer', header: 'Developer', accessorKey: 'developer' },
    ...
    hasAccess('achievement', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.achievement,
        }
      : null,
    hasAccess('tip', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'tip',
          header: 'Tip',
          accessorKey: 'tip',
          cell: ({ row: { original: record } }: any) => record?._count?.tip,
        }
      : null,
    hasAccess('trick', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'trick',
          header: 'Trick',
          accessorKey: 'trick',
          cell: ({ row: { original: record } }: any) => record?._count?.trick,
        }
      : null,
