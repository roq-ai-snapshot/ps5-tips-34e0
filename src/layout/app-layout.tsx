...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Tips', path: '/tips', entity: 'tip', service: AccessServiceEnum.PROJECT, icon: FiInfo },
    { name: 'Tricks', path: '/tricks', entity: 'trick', service: AccessServiceEnum.PROJECT, icon: FiStar },
