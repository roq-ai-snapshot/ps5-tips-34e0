...
export function useTipFindMany<
  T extends Prisma.tipFindManyArgs,
  R extends GetFindResult<Prisma.$tipPayload<DefaultArgs>, T>[],
>(args?: Prisma.SelectSubset<T, Prisma.tipFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useTipFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.tip.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTipCount<T extends Prisma.tipCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.tipCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useTipCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.tip.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTipFindManyWithCount<
  T extends Prisma.tipFindManyArgs,
  R extends { data: GetFindResult<Prisma.$tipPayload<DefaultArgs>, T>[]; count: number },
>(args?: Prisma.SelectSubset<T, Prisma.tipFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useTipFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.tip.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTipFindFirst<
  T extends Prisma.tipFindFirstArgs,
  R extends GetFindResult<Prisma.$tipPayload<DefaultArgs>, T>,
>(args?: Prisma.SelectSubset<T, Prisma.tipFindFirstArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useTipFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.tip.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTrickFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTrickFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.trick.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTrickCount<T extends Prisma.trickCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.trickCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useTrickCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.trick.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTrickFindManyWithCount<
  T extends Prisma.trickFindManyArgs,
  R extends { data: GetFindResult<Prisma.$trickPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.trickFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTrickFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.trick.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTrickFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTrickFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.trick.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
